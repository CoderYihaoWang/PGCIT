...
public class ElapsedTime {
	...
	public void getTimeElapsed(int firstHour, int firstMinutes, int secondHour, int secondMinutes) {
		...
		int allMinutes = 0;
		// Answer here
		int diff = secondHour * 60 + secondMinutes - firstHour * 60 - firstMinutes;
		int adjustment = Math.max(diff, 0) / maxTimeDiffInMinutes * maxTimeDiffInMinutes;
		allMinutes = (diff + maxTimeDiffInMinutes) % maxTimeDiffInMinutes + adjustment;
		//
